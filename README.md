...
A technology platform for gym owners, trainers and members.

**Focus:** Gym Management • AI • Attendance • Membership • Fitness
...
`React` `Node.js` `Express.js` `PostgreSQL` `Prisma` `REST API`
...
**Project:** SheetKosh / Cold Storage Ecosystem
